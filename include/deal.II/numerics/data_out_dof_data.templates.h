...
namespace internal
{
  namespace DataOutImplementation
  {
    ...
    namespace
    {
      ...
      {
        LinearAlgebra::ReadWriteVector<typename VectorType::value_type> temp(src.locally_owned_elements());
        temp.import(src, VectorOperation::insert);

        auto temp2 = LinearAlgebra::ReadWriteVector<Number>::create_with_same_size(temp);
        temp2 = temp;
